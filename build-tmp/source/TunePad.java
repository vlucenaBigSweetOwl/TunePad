...
MidiChannel[] channels;
 ...
 public int XtoS(int x, boolean quan){
	int time = s() + (x-width/2)*step();
	int off = 0;
	if(quan){
...
int pressX,pressY;
 ...
 public void mouseReleased(){
	...
	if(tool == TEMPO){
		if(lmHeld){
			tgate1 = (int)((XtoS(mouseX,false) - startTime + (tempo*.5f)) / tempo);
			tgate1s = XtoS(mouseX,false);
		} else if(rmHeld){
			tgate2 = (int)((XtoS(mouseX,false) - startTime + (tempo*.5f)) / tempo);
